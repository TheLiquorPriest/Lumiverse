...
const migration122Sql = await Bun.file(join(import.meta.dir, "122_persistent_workspace_chat_detach.sql")).text();
...
describe("122 persistent workspace chat detach migration", () => {
