...
export const BUILT_IN_SETTINGS_TABS: readonly SpindleUISettingsTabEntry[] = [
  ...
  { id: "contextLibrary", shortName: "Context Library", tabName: "Context Library", tabDescription: "Manage versioned context packs and their attachments", keywords: ["context", "library", "packs", "versions", "attachments", "acl", "portable"] },
